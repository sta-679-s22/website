...
`r fontawesome::fa("list")`  [Course syllabus](https://www.vizdata.org/syllabus.html) 

`r fontawesome::fa("calendar")`  [Course schedule](https://www.vizdata.org/schedule.html).
